            ...
            <form action="Categoria" method="post">
                ...
                <div class="row">
                    <div class="input-field col l4 s12">
                        <input id="txtNombre" type="text" name="Nombre" value="<%=categoria.getNombre()%>" required class="validate" maxlength="30" placeholder="Ingrese el Nombre">
                        <label for="txtNombre">Nombre</label>
                    </div>
                    <div class="input-field col l4 s12">
                        <input id="txtDescripcion" type="text" name="Descripcion" value="<%=categoria.getDescripcion()%>" required class="validate" maxlength="30" placeholder="Ingrese el Descripcion">
