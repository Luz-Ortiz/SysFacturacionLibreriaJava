...
import sysseguridad.accesoadatos.CategoriaDAL; // Importar la clase RolDAL de la capa de acceso a datos
import sysseguridad.entidadesdenegocio.Categoria;// Importar la clase Rol de la capa de entidades de negocio
...
public class CategoriaServlet extends HttpServlet {
    ...
    private void doGetRequestIndex(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            Categoria categoria = new Categoria(); // Crear una instancia  de la entidad de Rol.
            categoria.setTop_aux(10); // Agregar el Top_aux con el valor de 10 a la propiedad Top_aux de rol.
            ArrayList<Categoria> categorias = CategoriaDAL.buscar(categoria); // Ir a la capa de acceso a datos y buscar los registros de Rol.
            ...
            request.getRequestDispatcher("Views/Categoria/index.jsp").forward(request, response); // Direccionar al jsp index de Rol.
        } catch (Exception ex) {
    ...
    private void requestObtenerPorId(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (categoria_result.getIdCategoria() > 0) { // Si el Id es mayor a cero.
